/************************************************************************************************************************************************************
 * @file Ex_8_7.cpp
 * @brief Exercise 8.7: Revise the bookstore program from the previous section to write its output to a file. Pass the name
 *        of that file as a second argument to main.
 * @date 2023-12-25
 * 
