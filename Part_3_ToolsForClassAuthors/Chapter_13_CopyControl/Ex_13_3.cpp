/************************************************************************************************************************************************************
 * @file Ex_13_3.cpp
 * @brief Exercise 13.3: What happens when we copy a StrBlob? What about StrBlobPtrs?
 * @date 2024-01-22
 * 
...
/************************************************************************************************************************************************************
 * Synthesised copy constructor is used to do a memberwise copy, when we copy a StrBlob and StrBlobPtr objects.
 * 
 *************************************************************************************************************************************************************/
//  libraries needed
#include <iostream>
...
int main(){
    ...
    std::cout << "b1.usecount() : " << b1.count() << std::endl; 
    StrBlob b2 = b1;
    std::cout << "b2.usecount() : " << b2.count() << " " << "b1.usecount() : " << b1.count() << std::endl;
    StrBlobPtr iter1 = b2.begin();
    StrBlobPtr iter2 = iter1;
    std::cout << "after creating iterators : \nb2.usecount() : " << b2.count() << " " << "b1.usecount() : " << b1.count() << std::endl;
    std::cout << iter2.deref() << " ";
    iter2.incr();
