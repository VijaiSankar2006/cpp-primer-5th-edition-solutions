/************************************************************************************************************************************************************
 * @file Ex_14_26.cpp
 * @brief Exercise 14.26: Define subscript operators for your StrVec, String, StrBlob, and StrBlobPtr classes.
 * @date 2024-01-30
 * 
...
class StrBlob{
    ...
    public :
        ...
        std::string & operator[](const size_type i);
        const std::string & operator[](const size_type i) const ;
...
std::string & StrBlob::operator[](const size_type i){
    check(i, "out of bounds");
    return (*data)[i];
}

const std::string & StrBlob::operator[](const size_type i) const {
    check(i, "out of bounds");
    return (*data)[i];
}
...
std::string & ConstStrBlobPtr::operator[](const size_t i){
    check(i, "out of bounds");
    return (*wptr.lock())[i];
}
        
const std::string & ConstStrBlobPtr::operator[](const size_t i) const {
    check(i, "out of bounds");
    return (*wptr.lock())[i];
}
...
std::string & StrVec::operator[](const size_t i){
    if(i >= size()){
        std::cerr << "out of bounds" << std::endl;
    }
...
const std::string & StrVec::operator[](const size_t i) const {
    if(i >= size()){
        std::cerr << "out of bounds" << std::endl;
    }
...
int main(){
    ...
    const StrBlob cb1{"delta", "charlie", "echo"};
    ...
    StrVec svec{"alpha","beta", "gamma", "delta"};
    for(size_t i = 0; i < svec.size(); ++i){
        svec[i] = svec[i] + "segment";
    }
    std::cout << std::endl;
    print(svec);
