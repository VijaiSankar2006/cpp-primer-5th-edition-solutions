/************************************************************************************************************************************************************
 * @file Ex_14_16.cpp
 * @brief Exercise 14.16: Define equality and inequality operators for your StrBlob (§ 12.1.1, p. 456), StrBlobPtr (§ 12.1.6, p. 474),
 * StrVec (§ 13.5, p. 526), and String (§ 13.5, p. 531) classes.
 * @date 2024-01-30
 * 
...
int main(){
    StrVec svec1{"alpha", "beta", "gamma"}, svec2(svec1), svec3{"alpha","beta","Gamma"};
    std::cout << "#############################################################################" << std::endl;
    std::cout << "svec1 == svec2 : " << (svec1 == svec2) << std::endl;
    std::cout << "svec2 == svec3 : " << (svec2 == svec3) << std::endl;
    std::cout << "-------------------------------------------------------------------------" << std::endl;

    String str1("alpha"), str2("Alpha"), str3("alpha");
    std::cout << "str1 == Str2 : " << (str1 == str2) << std::endl;
    std::cout << "str1 != str3 : " << (str1 != str3) << std::endl;
    std::cout << "----------------------------------------------" << std::endl;

    StrBlob b1{"alpha", "beta", "charlie"}, b2{"alpha", "beta", "charlie"}, b3{"alpha", "beta", "charliE"};
    std::cout << "b1 == b2 : " << (b1 == b2) << std::endl;
    std::cout << "b1 != b3 : " << (b1 != b3) << std::endl;
    std::cout << "---------------------------------------" << std::endl;

    ConstStrBlobPtr bptr1 = b1.cbegin();
    ConstStrBlobPtr bptr2 = b2.cbegin();
    std::cout << "bptr1 != bptr2 : " << (bptr1 != bptr2) << std::endl;
    std::cout << "*bptr1 == *bptr2 : " << (bptr1.deref() == bptr2.deref()) << std::endl;
