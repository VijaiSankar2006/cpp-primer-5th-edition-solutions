/************************************************************************************************************************************************************
 * @file Ex_14_28.cpp
 * @brief Exercise 14.28: Define addition and subtraction for StrBlobPtr so that these operators implement pointer arithmetic
 * (§ 3.5.3, p. 119).
 * @date 2024-01-31
 * 
...
int main(){
    const StrBlob b1{"alpha","beta","gamma","delta"};
