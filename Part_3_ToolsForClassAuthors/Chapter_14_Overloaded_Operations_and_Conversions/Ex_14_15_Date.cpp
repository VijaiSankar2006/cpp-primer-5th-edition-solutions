/************************************************************************************************************************************************************
 * @file Ex_14_15.cpp
 * @brief Exercise 14.15: Should the class you chose for exercise 7.40 from § 7.5.1 (p. 291) define any of the arithmetic 
 * operators? If so, implement them. If not, explain why not.
 * @date 2024-01-30
 * 
...
int main(){
    Date d1(31,12,2023), d2(28,2,2024);
    Date::number diff = d1 - d2;
