/************************************************************************************************************************************************************
 * @file Ex_10_19.cpp
 * @brief Exercise 10.19: Rewrite the previous exercise to use stable_partition, which like stable_sort maintains the original
 *        element order in the paritioned sequence.
 * @date 2024-01-05
 * 
